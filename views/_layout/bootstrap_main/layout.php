...
<head>
<meta charset="UTF-8">
<meta name="naver-site-verification" content="e91be2ee6f021d54197adc5345011b0c6aec6887" />
...
<div class="wrapper">
<a href="#" class="top" style="display: block;"><img src="http://sulimnoc.com/views/_layout/bootstrap_main/images/toTop.png"></a>
	...
	<nav class="navbar navbar-default">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<!-- <div> -->
					<!-- <form class="navbar-form" name="header_search" id="header_search" action="<?php echo site_url('search'); ?>" onSubmit="return headerSearch(this);">
	...
	<footer>
		<div class="footer_1">
			<div class="wrap_footer">
				<div class="school_info">
					<div class="tit_circle">
						입학<br>상담
					</div>
					<ul>
						<li>오전 10시-오후 8시(점심시간 오전 11:30 ~ 오후 12:30)</li>	
						<li>1566-2198</li>	
						<li>태재고개역(버스정류장) 뒷편 굿모닝치과 2층</li>	
					</ul>
				</div>
				<ul class="sh_memu">
					<li><a href="#">시간표</a></li>					
                ...
                <div class="talk_banner_div" data-id="132736" style="width:170px;height:200px;"></div>
            </div>	
        </div>
        <div class="footer_2">
            <div>
                <ul class="company">
                    <li><a href="/document/sub1_1" title="회사소개">학원소개</a></li>
                    <li><a href="<?php echo site_url('pointranking'); ?>" title="포인트 전체랭킹">사회공헌</a></li>
                    <li><a href="<?php echo site_url('pointranking/month'); ?>" title="포인트 월별랭킹">인재채용</a></li>
                    <li><a href="<?php echo document_url('provision'); ?>" title="이용약관">이용약관</a></li>
                    <li><a href="<?php echo document_url('privacy'); ?>" title="개인정보 취급방침">개인정보처리방침</a></li>
                    <li><a href="<?php echo site_url('levelup'); ?>" title="레벨업">고객센터</a></li>
                </ul>
            </div>
        </div>
        <div class="container" style="text-align: center;">
            <div class="copyright">
                ...
                <?php } ?>
                <?php if ($this->cbconfig->item('company_owner')) { ?><span><b>원장</b> <?php echo $this->cbconfig->item('company_owner'); ?></span><?php } ?>
                <?php if ($this->cbconfig->item('company_phone')) { ?><span><b>대표전화</b> <?php echo $this->cbconfig->item('company_phone'); ?></span><?php } ?>
                <?php if ($this->cbconfig->item('company_fax')) { ?><span><b>팩스</b> <?php echo $this->cbconfig->item('company_fax'); ?></span><?php } ?>
            </div>
            <div class="copyright">
                <?php if ($this->cbconfig->item('company_reg_no')) { ?><span><b>사업자(신현학원-제2087호)</b> <?php echo $this->cbconfig->item('company_reg_no'); ?></span><?php } ?>
                <span><b>(신현정보미디어학원-제2086호)</b> 840-94-01482</span>
                <?php if ($this->cbconfig->item('company_admin_name')) { ?><span><b>정보관리책임자명</b> <?php echo $this->cbconfig->item('company_admin_name'); ?></span><?php } ?>
                <span><b>이메일문의</b> biz@townz.kr</span>
                <span style="display: block;">Copyright&copy; <?php echo $this->cbconfig->item('site_title'); ?>. All Rights Reserved.</span>
            </div>
            <?php
