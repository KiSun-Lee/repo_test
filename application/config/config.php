 ...
 */
$config['base_url'] = 'http://shschool.kr/';
 ...
 */
$config['encryption_key'] = 'htrhtrhtrhrthtrhrththrfdfrdgdf';
...
$config['cookie_domain'] = '.shschool.kr'; // .ciboard.co.kr 와 같이 맨 앞에 . 을 찍고 도메인 명을 적습니다
$config['cookie_path'] = '/';
